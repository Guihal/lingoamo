export function addSvgInBtn() {
	document.querySelectorAll(".btn-w-arrow:not(.check)").forEach((btn) => {
		btn.classList.add("check");
		btn.innerHTML = btn.innerHTML += svg;
	});

	document.querySelectorAll(".btn-w-arrow-small:not(.check)").forEach((btn) => {
		btn.classList.add("check");
